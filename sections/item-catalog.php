		...
		<div class="hover-appear hidden_" style="bottom: -75px;">
			<table class="table-data-catalogue">
				<tbody>
					...
					<th width="34%">
						<div class="quick-shop-window product-ajax-qs hidden-xs hidden-sm hidden HIDDEN_BUTTON">
							<div data-target="#product-w<?php echo $iddet?>" 
								class="quick_shop quick-shop-icono" data-toggle="modal">
								<!--
...
<?php include( "quick-product-modal-full.php" ); ?>
<style type="text/css">
