<div class="sb-wrapper">
	<div class="filter-tag-group">
		...
		<div class="tag-group" id="coll-filter-3">
			...
			<ul>
				<li><a title="Narrow selection to products matching tag Under $100" href="#"><span class="fe-checkbox"></span> Menos de $50</a></li>
				<li><a title="Narrow selection to products matching tag $100 - $200" href="#"><span class="fe-checkbox"></span> $50 - $100</a></li>
				<li><a title="Narrow selection to products matching tag Above $200" href="#"><span class="fe-checkbox"></span> Más de $100</a></li>
			</ul>
		</div>
		<!-- tags groupd 3 -->
	</div>
