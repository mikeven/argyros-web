				...
				<div class="row">
					<div class="col-md-12 product-image">
						<div id="quick-shop-image" class="product-image-wrapper">
							...
							<div align="center">
								<a id="url_lnkproduct" href="" class="action btn btn-1 url_lnkproduct" target="_blank">
									<i class="fa fa-eye"></i>
								</a>
							</div>
					...
					<div class="col-md-12 product-information">
						...
						<div id="quick-shop-infomation" class="description">
							...
							<div id="product-ids" class="text-left">
								<p> #xxxx-xxxx </p>
							</div>
						</div>
						<div id="quick-shop-container">
							...
							<form id="frm_scart" action="post" method="post" class="variants" enctype="multipart/form-data">
								...
								<div id="qs-data-tallas" class="quantity-wrapper clearfix">
