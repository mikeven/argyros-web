<?php
	foreach ( $productos_juegos as $rdet_j ) {
		if( count( $rdet_j["juego_detalle"] ) > 0 ) {
?>
<section id="epj<?php echo $rdet_j["id_dp"]?>" 
	class="rel-container clearfix epjuego" style="display: none;">  
	<h6 class="general-title text-left">Productos del juego</h6>
	<div id="prod-related-wrapper">
		<div id="productos-juego" class="prod-related clearfix">
		<?php
				foreach ( $rdet_j["juego_detalle"] as $prod ) {
		...
		?>
			<div class="element no_full_width not-animated rdet_juego_rel rdj<?php echo $rdet_j["id_dp"]?>" data-animate="bounceIn" data-delay="0">
