		...
		<div id="content-wrapper">  
			...
			<div id="content" class="clearfix">        
				...
				<section class="content">
					<div class="container">
						<div class="row">  
							<?php include( "sections/left-siderbar-product.php" );?>
										...
										<div id="product-information" class="product-information row text-center no_full_width col-sm-12">        
											...
											<div id="product-header" class="clearfix">
												<div id="product-info-right">     
															...
															<div id="product-actions-1293235843" class="options clearfix">
																...
																<div class="swatch clearfix" data-option-index="1">
																	...
																	<div data-value="small" class="swatch-element small available">
																		...
																		6 <img class="crossed-out" src="assets/images/soldout.png" alt="">
																		</label>
																	</div>
																	<div data-value="medium" class="swatch-element medium available">
																		<input id="swatch-1-medium" name="option-1" value="medium" type="radio">
																		<label for="swatch-1-medium">
																		7 <img class="crossed-out" src="assets/images/soldout.png" alt="">
																		</label>
																	</div>
																</div>
													...
													<!-- tabs_detail, pop-one, pop-two, pop-three -->
													<!-- /.tabs_detail, pop-one, pop-two, pop-three -->
										...
										<div class="prod-related clearfix">
											<div class="element no_full_width not-animated" data-animate="bounceIn" data-delay="0">
												<ul class="row-container list-unstyled clearfix">
													...
													<div class="product-content-left">
														<a class="title-5" href="product.html">Anillo 1</a>
											...
											<div class="element no_full_width bounceIn not-animated" data-animate="bounceIn" data-delay="400">
												<ul class="row-container list-unstyled clearfix">
													...
													<li class="row-right parent-fly animMix">
													<div class="product-content-left">
														<a class="title-5" href="product.html">Zarcillo</a>
													...
													<div class="product-content-right">
														<div class="product-price">
															...
															<del class="price_compare"> $109.00</del>
														</div>
													</div>
													<div class="list-mode-description">
														 Descripción
											...
											<div class="element no_full_width bounceIn not-animated" data-animate="bounceIn" data-delay="600">
												<ul class="row-container list-unstyled clearfix">
													...
													<li class="row-right parent-fly animMix">
													<div class="product-content-left">
														<a class="title-5" href="product.html">Collar</a>
											...
											<div class="element no_full_width bounceIn not-animated" data-animate="bounceIn" data-delay="800">
												<ul class="row-container list-unstyled clearfix">
													...
													<li class="row-right parent-fly animMix">
													<div class="product-content-left">
														<a class="title-5" href="product.html">Collar 2</a>
														<span class="spr-badge" id="spr_badge_1293227907" data-rating="3.0">
														<span class="spr-starrating spr-badge-starrating"><i class="spr-icon spr-icon-star" style=""></i>
													...
													<div class="product-content-right">
														<div class="product-price">
															<span class="price_sale">$21.00</span>
															<del class="price_compare"> $39.00</del>
														</div>
													</div>
													<div class="list-mode-description">
														 Descripción
											...
											<div class="element no_full_width not-animated" data-animate="bounceIn" data-delay="1000">
												<ul class="row-container list-unstyled clearfix">
													...
													<li class="row-right parent-fly animMix">
													<div class="product-content-left">
														<a class="title-5" href="product.html">Zarcillo 2</a>
													...
													<div class="product-content-right">
														<div class="product-price">
															<span class="price_sale">$81.00</span>
