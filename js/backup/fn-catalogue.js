 ...
 */
 /* ----------------------------------------------------------------------------------- */
 function cargarElementosCatalogo( ini, fin ){
	...
	$.ajax({
        ...
        data:{ listar_catalogo_url: curl, pos_i: ini, pos_f: fin },
        beforeSend: function(){
            $("#carga_catalogo").html( loader_gif );
        },
        success: function( response ){
            $("#sandBox").append( response ); 
            $("#carga_catalogo").html( "" );      
        }
    });
 }
 ...
 $( document ).ready(function() {	
    ...
    $( "#sandBox" ).on( "click", ".btn_vermas", function(){
        ...
        cargarElementosCatalogo( elemento_inicio, elemento_fin );
    });
    /* .................................................................... */
